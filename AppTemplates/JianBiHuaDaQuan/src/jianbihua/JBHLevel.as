...
import org.mousebomb.GameConf;
	...
	public class JBHLevel extends Sprite  implements IDispose,IFlyIn {
		...
		public function JBHLevel() {
			...
			shelf.setList(levelModel.categorys[levelModel.category]);
			if(lastPage>0) shelf.showPage(lastPage);

			if (levelModel.categorys[levelModel.category].length > rows * 3) {
				//
		...
		private function onBackClick(event : MouseEvent) : void {
			...
			JianBiHua.instance.replaceScene(new JBHCategory());
		}
