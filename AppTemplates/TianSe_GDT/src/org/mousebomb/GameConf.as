...
import flash.desktop.NativeApplication;
	...
	public class GameConf
	{
        ...
        // 广点通
        public static const GDT_ANDROID_APPID:String = "${androidGDTAppID}";
        public static const GDT_ANDROID_BANNER:String = "${androidGDTBanner}";
        public static const GDT_ANDROID_INTERSTITIAL:String = "${androidGDTInterstitial}";
